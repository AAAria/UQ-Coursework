...
Sample part of data for faster processing:
```{r}
# Prepare data
...
SVMfit <- train(x_train_nzv, y_train, method = "svmRadial", trControl = ctrl)
...
conf_SVM_test <- as.matrix(confusionMatrix(factor(pred_SVM), y_test))
conf_SVM_test
